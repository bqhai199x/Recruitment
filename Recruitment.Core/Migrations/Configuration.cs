namespace Recruitment.Core.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Recruitment.Core.CandidateDbContext>
    {
        ...
        protected override void Seed(Recruitment.Core.CandidateDbContext context)
        {
            //Position
